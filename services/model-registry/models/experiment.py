...
class Experiment(Base):
    ...
    experiment_type = Column(String(100), nullable=True)  # training, tuning, evaluation, etc.
    
    # Execution information
    run_id = Column(String(255), nullable=True, unique=True)  # External run ID (MLflow, etc.)
    ...
    # Lineage
    parent_experiment_id = Column(UUID(as_uuid=True), ForeignKey("experiments.id"), nullable=True)
