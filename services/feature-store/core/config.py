...
class Settings(BaseSettings):
    ...
    # S3/MinIO settings
    S3_ENDPOINT: Optional[str] = Field(default="http://localhost:9000", env="S3_ENDPOINT")
    ...
    MATERIALIZATION_BATCH_SIZE: int = Field(default=10000, env="MATERIALIZATION_BATCH_SIZE")
    ...
    TIME_SERIES_RETENTION_DAYS: int = Field(default=90, env="TIME_SERIES_RETENTION_DAYS")
