...
async def create_feature_set(
    feature_set_data: FeatureSetCreate,
    ...
    try:
        ...
        existing = db.query(FeatureSet).filter(
            FeatureSet.name == feature_set_data.name
        ).first()
...
async def get_feature_set_statistics(
    ...
    return {
        ...
        "last_materialization": feature_set.last_materialization.isoformat() if feature_set.last_materialization else None,
