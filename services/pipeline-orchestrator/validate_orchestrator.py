...
def validate_directory_structure():
    ...
    checks.append(check_file_exists(os.path.join(base_dir, "core", "dag.py"), "DAG engine"))
    checks.append(check_file_exists(os.path.join(base_dir, "core", "scheduler.py"), "Intelligent scheduler"))
    checks.append(check_file_exists(os.path.join(base_dir, "core", "executor.py"), "Task executor"))
    checks.append(check_file_exists(os.path.join(base_dir, "core", "resource_manager.py"), "Resource manager"))
    ...
    checks.append(check_file_exists(os.path.join(base_dir, "api", "routes", "pipelines.py"), "Pipeline management"))
    checks.append(check_file_exists(os.path.join(base_dir, "api", "routes", "runs.py"), "Run management"))
