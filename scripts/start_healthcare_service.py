...
class HealthcareResponses:
    ...
    def get_response(self, user_input):
        ...
        # Category detection
        if any(word in input_lower for word in ['walk', 'mobility', 'transfer', 'fall', 'balance']):
            category = 'mobility'
        elif any(word in input_lower for word in ['anxiety', 'panic', 'worried', 'stressed']):
            category = 'anxiety'
        elif any(word in input_lower for word in ['elderly', 'senior', 'parent', 'lonely', 'aging']):
            category = 'senior_care'
        elif any(word in input_lower for word in ['caregiver', 'caring for', 'exhausted', 'respite', 'break']):
            category = 'caregiver'
        elif any(word in input_lower for word in ['disability', 'wheelchair', 'adaptive', 'accessibility']):
            category = 'disability'
        else:
            category = 'general'
