...
def check_dependencies():
    ...
    required_packages = ["mlflow", "psutil", "matplotlib", "seaborn"]

    optional_packages = ["nvidia-ml-py", "gpustat"]
    ...
    if missing_optional:
        ...
        print(
            "For GPU monitoring, install with: pip install "
...
def setup_system_metrics_experiment():
    ...
    try:
        ...
        with mlflow.start_run(run_name="system-metrics-test"):
            ...
            print(
                f"  🔗 View at: http://localhost:5001/#/experiments/{experiment.experiment_id}/runs/{run_id}"
            )
...
def verify_artifact_storage():
    ...
    try:
        ...
        with mlflow.start_run(run_name="artifact-storage-test"):
            ...
            print(
                f"  🔗 View artifacts at: http://localhost:5001/#/experiments/0/runs/{run_id}"
            )
...
'''
    ...
    example_path = Path(
        "/Users/snegi/Documents/github/mlops-project/scripts/example_training_with_metrics.py"
    )
...
if __name__ == "__main__":
    ...
    if success:
        ...
        print(
            "Follow the recommendations above to enable system metrics in your training."
        )
    else:
