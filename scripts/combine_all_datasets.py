...
def combine_all_datasets():
    ...
    combined_stats = {
        ...
        'dataset_distribution': {
            ...
            'specialized_mental_health': dataset_stats.get('mental_health_specialized', 0),
            'specialized_respite_care': dataset_stats.get('respite_care_specialized', 0),
            'specialized_disabilities': dataset_stats.get('disabilities_specialized', 0)
        },
        'training_ready': True,
        'version': '4.0.0'
    }
