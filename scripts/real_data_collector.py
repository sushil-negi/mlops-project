...
class RealDataCollector:
    ...
    def collect_all_real_data(self) -> List[Dict[str, Any]]:
        ...
        logger.info(f"Total real data collected: {len(all_conversations)} conversations")
    ...
    def _generate_real_data_stats(self, conversations: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        return {
            ...
            'data_quality': {
                'medical_disclaimer_coverage': sum(1 for c in conversations if c.get('metadata', {}).get('medical_disclaimer', False)),
                'authority_verified': sum(1 for c in conversations if c.get('metadata', {}).get('authority') != 'unknown')
            }
        }
...
def main():
    ...
    # Save data
    output_path = '/Users/snegi/Documents/github/mlops-project/data/real_healthcare_data.json'
