...
class HealthcareInferenceEngine:
    ...
    def __init__(self):
        ...
        self.safety_keywords = ['diagnose', 'treat', 'cure', 'medicine', 'prescription', 'symptom']
    ...
    def load_healthcare_knowledge(self) -> Dict:
        ...
        return {
            'fitness': {
                'keywords': ['exercise', 'fitness', 'workout', 'training', 'gym', 'activity', 'movement'],
                'responses': [
            ...
            'nutrition': {
                'keywords': ['nutrition', 'eating', 'food', 'meal', 'diet', 'healthy eating', 'cooking'],
                'responses': [
            ...
            'mental_wellness': {
                'keywords': ['stress', 'anxiety', 'mental', 'mindful', 'meditation', 'relaxation', 'mood'],
                'responses': [
            ...
            'sleep': {
                'keywords': ['sleep', 'bedtime', 'insomnia', 'rest', 'tired', 'fatigue'],
                'responses': [
            ...
            'lifestyle': {
                'keywords': ['routine', 'habits', 'lifestyle', 'wellness', 'balance', 'self-care'],
                'responses': [
            ...
            'prevention': {
                'keywords': ['prevent', 'prevention', 'immune', 'health', 'wellness', 'safety'],
                'responses': [
    ...
    def generate_healthcare_response(self, prompt: str, max_length: int = 100, temperature: float = 0.7) -> str:
        """Generate appropriate healthcare response"""
        
        # Safety check
        if self.check_medical_safety(prompt):
            return ("I provide wellness and lifestyle advice, not medical guidance. "
...
def test_healthcare_engine():
    ...
    for i, prompt in enumerate(test_prompts[:5], 1):
        print(f"\n{i}. Prompt: '{prompt}'")
        response = engine.generate_healthcare_response(prompt, max_length=80, temperature=0.7)
