...
class HealthcareAIEngine:
        ...
        knowledge = {
            'category_keywords': {
                ...
                'senior_care': ['elderly', 'senior', 'aging', 'parent', 'grandfather', 'grandmother', 
                               'lonely', 'isolation', 'memory', 'medication', 'aging in place'],
    ...
    def generate_response(self, user_input: str, use_history: bool = True) -> Dict:
        ...
        responses = self.knowledge_base['responses'].get(category, self.knowledge_base['responses']['general'])
    ...
    def get_conversation_stats(self) -> Dict:
        ...
        return {
            ...
            'cache_hit_rate': self.statistics['cache_hits'] / max(1, self.statistics['total_requests']),
