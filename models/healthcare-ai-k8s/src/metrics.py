...
category_requests = Counter(
    'healthcare_ai_category_requests_total',
...
def update_model_metrics(accuracy: float, crisis_rate: float, empathy: float, version: str = "unknown"):
