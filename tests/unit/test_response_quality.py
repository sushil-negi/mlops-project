...
class TestMLClassificationAccuracy:
    ...
    def engine_with_predictions(self, tmp_path):
        ...
        X = ["mobility help", "self care", "medication", "social", "anxiety", 
             "depression", "respite", "burnout", "equipment", "rights", "crisis"]
        y = list(range(11))
        pipeline.fit(X, y)
        
        model_data = {
            'pipeline': pipeline,
            'category_mapping': {i: cat for i, cat in enumerate([
                'adl_mobility', 'adl_self_care', 'senior_medication', 
                'senior_social', 'mental_health_anxiety', 'mental_health_depression',
                'caregiver_respite', 'caregiver_burnout', 'disability_equipment',
                'disability_rights', 'crisis_mental_health'
            ])},
            'healthcare_responses': {
    ...
    def test_ml_classification_medication(self, engine_with_predictions):
        ...
        response = engine.generate_response("How should I organize my medications and pills")
    ...
    def test_ml_classification_confidence_threshold(self, engine_with_predictions):
        ...
        response = engine.generate_response("General healthcare question about wellness")
...
class TestCrisisDetection:
    ...
    def engine(self, tmp_path):
        ...
        model_data = {
            ...
            'healthcare_responses': {
                'crisis_mental_health': ["🚨 CRISIS SUPPORT 🚨\n\nCall 988 or 911 immediately."]
            }
        }
...
class TestResponseCaching:
    ...
    def engine(self, tmp_path):
        ...
        model_data = {
            ...
            'healthcare_responses': {
                'adl_mobility': ["Test response for caching"]
            }
        }
...
class TestResponseFormatting:
    ...
    def engine(self, tmp_path):
        ...
        model_data = {
            ...
            'category_mapping': {0: 'adl_mobility'},
            'healthcare_responses': {
                'adl_mobility': ["Test response for formatting. ⚠️ Consult healthcare providers."]
            }
        }
    ...
    def test_response_structure(self, engine):
        ...
        required_fields = ['response', 'category', 'confidence', 'method', 'generation_time']
    ...
    def test_response_contains_warning(self, engine):
        ...
        response = engine.generate_response("My elderly father has trouble getting out of bed")
